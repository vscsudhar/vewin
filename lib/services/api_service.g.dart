...
class _ApiService implements ApiService {
  ...
  @override
  Future<List<PaymentListResponse>> payMentList(
      PaymentListRequest paymentListRequest) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(paymentListRequest.toJson());
    final _result = await _dio
        .fetch<List<dynamic>>(_setStreamType<List<PaymentListResponse>>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    var value = _result.data!
        .map((dynamic i) =>
            PaymentListResponse.fromJson(i as Map<String, dynamic>))
        .toList();
    return value;
  }
