...
PanNoAddResponse panNoAddResponseFromJson(String str) => PanNoAddResponse.fromJson(json.decode(str));

String panNoAddResponseToJson(PanNoAddResponse data) => json.encode(data.toJson());
...
class PanNoAddResponse {
    ...
    factory PanNoAddResponse.fromJson(Map<String, dynamic> json) => PanNoAddResponse(
...
PanAddRequest panAddRequestFromJson(String str) => PanAddRequest.fromJson(json.decode(str));
