...
mixin NavigationMixin {
  ...
  void goToGetSalesList() =>
      _navigationService.replaceWith(Routes.getSalesDetailsView);
  void goToProfile() => _navigationService.navigateTo(Routes.profileView);
  void goToAppCustomerList() =>
      _navigationService.navigateTo(Routes.appCustomerListView);
  ...
  void goToAnnouncement(Announcement announcement) =>
      _navigationService.navigateTo(Routes.announcementDescriptionView,
          arguments:
              AnnouncementDescriptionViewArguments(announcement: announcement));
