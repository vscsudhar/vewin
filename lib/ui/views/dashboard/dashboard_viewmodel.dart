...
class DashboardViewModel extends BaseViewModel with NavigationMixin {
  ...
  List<ProfileImageUpdateResponse> get profileImageUpdateResponse =>
      _profileImageUpdateResponse;
  ...
  List<String> get upDateImage => profileImageUpdateResponse
      .map((e) => e.profile.toString())
      .toSet()
      .toList();
  ...
  Future<void> updateProfileImage() async {
    final updateresponse =
        await runBusyFuture(_apiService.updateProfileImage(id))
            .catchError((err) {
      print(err);
    });
    print(updateresponse.profile.toString());
    _sharedPreference.setString(
        'updateProfile', updateresponse.profile.toString());
  }
